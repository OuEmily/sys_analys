...
# читает json и возвращает содержимое как строку
def load_ranking(filepath):
    with open(filepath, 'r', encoding='utf-8') as f:
        return f.read().strip()


# преобразует строку json в python
def parse_ranking(raw_json):
    return json.loads(raw_json)


# собирает все уникальные элементы из списка ранжировок
...
# строит массив позиций для ранжировки
...
# строит матрицу доминирования по позициям
...
# вычисляет ядро противоречий между двумя матрицами
...
# сравнивает две ранжировки и возвращает ядро противоречий
...
# сравнивает две ранжировки из файлов
